...
#define MAX_ENVIRONMENTS                10    // MAX_NODES*MAX_NODES if dynamic environments are used
#define MAX_MOTIONS                     1000
#define MAX_CONNECTIONS                 1000000 // MAX_NODES*MAX_NODES
