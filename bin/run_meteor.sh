...
echo "meteor -Q ${scenario_name} -s ${scenario_setting} -c ${scenario_connection} -I ${IF1} -I ${IF2} -d bridge -l -e ${EXEC}"
monitor_tc -i ${INGRESS_IF} -q -o /var/tmp/meteor_${TIME} &
meteor -Q ${scenario_name} -s ${scenario_setting} -c ${scenario_connection} -I ${IF1} -I ${IF2} -d bridge -l -e ${EXEC}
