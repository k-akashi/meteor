...
int
rtnl_open_byproto(rth, subscriptions, protocol)
struct rtnl_handle *rth;
...
int
rtnl_wilddump_request(rth, family, type)
struct rtnl_handle *rth;
int family;
int type;
{
...
int
rtnl_dump_request(rth, type, req, len)
struct rtnl_handle *rth;
int type;
void *req;
int len;
...
int
rtnl_dump_filter(rth, filter, arg1, junk, arg2)
struct rtnl_handle *rth;
...
int
rtnl_from_file(rtnl, handler, jarg)
FILE *rtnl;
rtnl_filter_t handler;
void *jarg;
{
...
int
addattr_l(n, maxlen, type, data, alen)
struct nlmsghdr *n;
int maxlen;
int type;
const void *data;
...
int
rta_addattr32(rta, maxlen, type, data)
struct rtattr *rta;
int maxlen;
int type;
uint32_t data;
...
int
rta_addattr_l(rta, maxlen, type, data, alen)
struct rtattr *rta;
int maxlen;
int type;
const void *data;
...
int
parse_rtattr_byindex(tb, max, rta, len)
struct rtattr *tb[];
int max;
struct rtattr *rta;
int len;
